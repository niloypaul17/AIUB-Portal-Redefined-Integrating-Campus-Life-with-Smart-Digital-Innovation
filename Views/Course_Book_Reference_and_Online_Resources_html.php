...
<html lang="en">
    <head>
        <title>Course Book Reference and Online Resources</title>
    ...
    <body>
        ...
        <form method="post" id="f1" onsubmit="return checkbook()">
            ...
            <input type="submit" id="IB1" value="Search">
            
            <div id="c1">
                <?php 
                if (!empty($massage) || !empty($massage2)) {
                    if (!empty($massage)){ echo "<p>$massage</p>"; }
                    if (!empty($massage2)){ echo "<div>$massage2</div>"; }
                } else {
                    echo "<p>After filling all fields click on Search Button</p>";
                }
                ?>    
            </div>
        </form>
        <div id="INF1">
            <center><b>COURSE NAMES</b></center>
            <br>
