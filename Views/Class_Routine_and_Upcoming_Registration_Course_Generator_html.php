...
require_once("../Controllers/Class_Routine_and_Upcoming_Registration_Course_Generator_Valid_js.php");
?>
<!DOCTYPE html>
<html lang="en">
<html>
    ...
    <body>
        ...
        <form method="post" id="f1" onsubmit="return checkclass()">
            ...
            <div class="div">
                ...
                <p><?php if(isset($massage2)){echo $massage2;}else{echo "Imvalid input! Try again";}?></p>
             </center>
        </form>
    </body>
</html>